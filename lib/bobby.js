...
exports.default = function (sample, schema) {
  ...
  (0, _keys2.default)(schema).forEach(function (field) {
    ...
    (0, _keys2.default)(schemaField).forEach(function (rule) {
      ...
      var pass = _rules2.default[rule] && _rules2.default[rule](value, expected) || rule === 'message';
      if (pass !== true) errors.push({ field: field, rule: rule, expected: expected, value: value, message: schemaField.message });
    });
  });
